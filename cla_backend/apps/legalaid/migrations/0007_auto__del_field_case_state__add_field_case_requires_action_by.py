...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Case.state'
        db.delete_column(u'legalaid_case', 'state')

        # Adding field 'Case.requires_action_by'
        db.add_column(u'legalaid_case', 'requires_action_by',
                      self.gf('django.db.models.fields.CharField')(default='operator', max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Case.state'
        db.add_column(u'legalaid_case', 'state',
                      self.gf('django.db.models.fields.CharField')(default='open', max_length=50),
                      keep_default=False)

        # Deleting field 'Case.requires_action_by'
        db.delete_column(u'legalaid_case', 'requires_action_by')
