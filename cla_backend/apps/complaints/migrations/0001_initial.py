            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        max_length=15,
                        choices=[(b"EMAIL", b"email"), (b"PHONE", b"phone"), (b"LETTER", b"letter")],
                    ),
                ),
                ...
                (
                    "created_by",
                    models.ForeignKey(
                        related_name="complaints_complaint_created_by",
                        blank=True,
                ...
                (
                    "owner",
                    models.ForeignKey(
                        related_name="complaints_complaint_owner", blank=True, to=settings.AUTH_USER_MODEL, null=True
                    ),
                ),
            ],
