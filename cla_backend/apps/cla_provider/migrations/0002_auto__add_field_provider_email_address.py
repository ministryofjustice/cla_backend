...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Provider.email_address'
        db.add_column(u'cla_provider_provider', 'email_address',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Provider.email_address'
        db.delete_column(u'cla_provider_provider', 'email_address')
