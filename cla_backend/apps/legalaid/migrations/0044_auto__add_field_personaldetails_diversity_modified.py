...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonalDetails.diversity_modified'
        db.add_column(u'legalaid_personaldetails', 'diversity_modified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonalDetails.diversity_modified'
        db.delete_column(u'legalaid_personaldetails', 'diversity_modified')
