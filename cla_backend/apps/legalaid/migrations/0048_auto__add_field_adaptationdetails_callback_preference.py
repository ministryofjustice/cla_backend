...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdaptationDetails.callback_preference'
        db.add_column(u'legalaid_adaptationdetails', 'callback_preference',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdaptationDetails.callback_preference'
        db.delete_column(u'legalaid_adaptationdetails', 'callback_preference')
