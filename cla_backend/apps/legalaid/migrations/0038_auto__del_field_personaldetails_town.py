...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PersonalDetails.town'
        db.delete_column(u'legalaid_personaldetails', 'town')


    def backwards(self, orm):
        # Adding field 'PersonalDetails.town'
        db.add_column(u'legalaid_personaldetails', 'town',
