...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PersonalDetails.date_of_birth'
        db.alter_column(u'legalaid_personaldetails', 'date_of_birth', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'PersonalDetails.date_of_birth'
        db.alter_column(u'legalaid_personaldetails', 'date_of_birth', self.gf('django.db.models.fields.DateTimeField')(null=True))
