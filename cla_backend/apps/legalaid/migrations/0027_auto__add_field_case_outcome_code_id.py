...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.outcome_code_id'
        db.add_column(u'legalaid_case', 'outcome_code_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.outcome_code_id'
        db.delete_column(u'legalaid_case', 'outcome_code_id')
