...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EligibilityCheck.is_under_eighteen'
        db.add_column(u'legalaid_eligibilitycheck', 'is_under_eighteen',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EligibilityCheck.is_under_eighteen'
        db.delete_column(u'legalaid_eligibilitycheck', 'is_under_eighteen')
