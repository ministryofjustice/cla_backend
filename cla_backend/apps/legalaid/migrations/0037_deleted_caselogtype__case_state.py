...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CaseLogType.case_state'
        db.delete_column(u'legalaid_caselogtype', 'case_state')


    def backwards(self, orm):
        # Adding field 'CaseLogType.case_state'
        db.add_column(u'legalaid_caselogtype', 'case_state',
