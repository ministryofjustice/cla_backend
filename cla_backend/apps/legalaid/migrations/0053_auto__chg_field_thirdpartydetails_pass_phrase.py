...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ThirdPartyDetails.pass_phrase'
        db.alter_column(u'legalaid_thirdpartydetails', 'pass_phrase', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'ThirdPartyDetails.pass_phrase'
        db.alter_column(u'legalaid_thirdpartydetails', 'pass_phrase', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
