...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.complaint_flag'
        db.add_column(u'legalaid_case', 'complaint_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.complaint_flag'
        db.delete_column(u'legalaid_case', 'complaint_flag')
    ...
    models = {
        ...
        u'legalaid.case': {
            ...
            'complaint_flag': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
        ...
        u'legalaid.casenoteshistory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'include_in_summary': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
