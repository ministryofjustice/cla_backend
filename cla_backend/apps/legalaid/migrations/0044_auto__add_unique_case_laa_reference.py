...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Case', fields ['laa_reference']
        db.create_unique(u'legalaid_case', ['laa_reference'])


    def backwards(self, orm):
        # Removing unique constraint on 'Case', fields ['laa_reference']
        db.delete_unique(u'legalaid_case', ['laa_reference'])
