...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.exempt_user'
        db.add_column(u'legalaid_case', 'exempt_user',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Case.exempt_user_reason'
        db.add_column(u'legalaid_case', 'exempt_user_reason',
    ...
    def backwards(self, orm):
        # Deleting field 'Case.exempt_user'
        db.delete_column(u'legalaid_case', 'exempt_user')

        # Deleting field 'Case.exempt_user_reason'
        db.delete_column(u'legalaid_case', 'exempt_user_reason')
