...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EligibilityCheck.disputed_savings'
        db.add_column(u'legalaid_eligibilitycheck', 'disputed_savings',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legalaid.Savings'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EligibilityCheck.disputed_savings'
        db.delete_column(u'legalaid_eligibilitycheck', 'disputed_savings_id')
    ...
    models = {
        ...
        u'legalaid.eligibilitycheck': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_under_eighteen': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
