...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('legalaid', '0005_auto_20150814_1136'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.OneToOneField(related_query_name=b'old_case', related_name='old_case', null=True, blank=True, to='legalaid.EODDetails'),
