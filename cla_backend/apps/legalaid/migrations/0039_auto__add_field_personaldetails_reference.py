...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonalDetails.reference'
        db.add_column(u'legalaid_personaldetails', 'reference',
                      self.gf('uuidfield.fields.UUIDField')(max_length=32, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonalDetails.reference'
        db.delete_column(u'legalaid_personaldetails', 'reference')
    ...
    models = {
        ...
        u'legalaid.personaldetails': {
            ...
            'reference': ('uuidfield.fields.UUIDField', [], {'max_length': '32', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
