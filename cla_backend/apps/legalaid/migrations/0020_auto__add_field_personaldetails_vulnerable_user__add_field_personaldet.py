...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonalDetails.vulnerable_user'
        db.add_column(u'legalaid_personaldetails', 'vulnerable_user',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonalDetails.safe_to_contact'
        db.add_column(u'legalaid_personaldetails', 'safe_to_contact',
                      self.gf('django.db.models.fields.CharField')(default='SAFE', max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonalDetails.vulnerable_user'
        db.delete_column(u'legalaid_personaldetails', 'vulnerable_user')

        # Deleting field 'PersonalDetails.safe_to_contact'
        db.delete_column(u'legalaid_personaldetails', 'safe_to_contact')
