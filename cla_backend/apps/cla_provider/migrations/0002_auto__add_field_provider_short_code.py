...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Provider.short_code'
        db.add_column(u'cla_provider_provider', 'short_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Provider.short_code'
        db.delete_column(u'cla_provider_provider', 'short_code')
