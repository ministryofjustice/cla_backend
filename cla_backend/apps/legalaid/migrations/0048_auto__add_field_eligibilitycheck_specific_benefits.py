...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EligibilityCheck.specific_benefits'
        db.add_column(u'legalaid_eligibilitycheck', 'specific_benefits',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EligibilityCheck.specific_benefits'
        db.delete_column(u'legalaid_eligibilitycheck', 'specific_benefits')
