...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonalDetails.date_of_birth'
        db.add_column(u'legalaid_personaldetails', 'date_of_birth',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonalDetails.ni_number'
        db.add_column(u'legalaid_personaldetails', 'ni_number',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonalDetails.exempt_user'
        db.add_column(u'legalaid_personaldetails', 'exempt_user',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonalDetails.exempt_user_reason'
        db.add_column(u'legalaid_personaldetails', 'exempt_user_reason',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonalDetails.contact_for_research'
        db.add_column(u'legalaid_personaldetails', 'contact_for_research',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ThirdPartyDetails.spoke_to'
        db.add_column(u'legalaid_thirdpartydetails', 'spoke_to',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ThirdPartyDetails.no_contact_reason'
        db.add_column(u'legalaid_thirdpartydetails', 'no_contact_reason',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonalDetails.date_of_birth'
        db.delete_column(u'legalaid_personaldetails', 'date_of_birth')

        # Deleting field 'PersonalDetails.ni_number'
        db.delete_column(u'legalaid_personaldetails', 'ni_number')

        # Deleting field 'PersonalDetails.exempt_user'
        db.delete_column(u'legalaid_personaldetails', 'exempt_user')

        # Deleting field 'PersonalDetails.exempt_user_reason'
        db.delete_column(u'legalaid_personaldetails', 'exempt_user_reason')

        # Deleting field 'PersonalDetails.contact_for_research'
        db.delete_column(u'legalaid_personaldetails', 'contact_for_research')

        # Deleting field 'ThirdPartyDetails.spoke_to'
        db.delete_column(u'legalaid_thirdpartydetails', 'spoke_to')

        # Deleting field 'ThirdPartyDetails.no_contact_reason'
        db.delete_column(u'legalaid_thirdpartydetails', 'no_contact_reason')
    ...
    models = {
        ...
        u'legalaid.personaldetails': {
            ...
            'exempt_user_reason': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
