...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.locked_by'
        db.add_column(u'legalaid_case', 'locked_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='case_locked', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.locked_by'
        db.delete_column(u'legalaid_case', 'locked_by_id')
