...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CaseKnowledgebaseAssignment'
        db.create_table(u'legalaid_caseknowledgebaseassignment', (
            ...
            ('alternative_help_article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['knowledgebase.Article'])),
            ('assigned_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal(u'legalaid', ['CaseKnowledgebaseAssignment'])


    def backwards(self, orm):
        # Deleting model 'CaseKnowledgebaseAssignment'
        db.delete_table(u'legalaid_caseknowledgebaseassignment')
