...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaseNotesHistory.include_in_summary'
        db.add_column(u'legalaid_casenoteshistory', 'include_in_summary',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CaseNotesHistory.include_in_summary'
        db.delete_column(u'legalaid_casenoteshistory', 'include_in_summary')
