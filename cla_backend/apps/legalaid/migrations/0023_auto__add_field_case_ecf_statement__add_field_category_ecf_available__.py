...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.ecf_statement'
        db.add_column(u'legalaid_case', 'ecf_statement',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.ecf_available'
        db.add_column(u'legalaid_category', 'ecf_available',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Category.mandatory'
        db.add_column(u'legalaid_category', 'mandatory',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.ecf_statement'
        db.delete_column(u'legalaid_case', 'ecf_statement')

        # Deleting field 'Category.ecf_available'
        db.delete_column(u'legalaid_category', 'ecf_available')

        # Deleting field 'Category.mandatory'
        db.delete_column(u'legalaid_category', 'mandatory')
