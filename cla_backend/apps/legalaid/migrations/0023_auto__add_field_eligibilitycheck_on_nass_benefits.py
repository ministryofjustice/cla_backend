...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EligibilityCheck.on_nass_benefits'
        db.add_column(u'legalaid_eligibilitycheck', 'on_nass_benefits',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EligibilityCheck.on_nass_benefits'
        db.delete_column(u'legalaid_eligibilitycheck', 'on_nass_benefits')
