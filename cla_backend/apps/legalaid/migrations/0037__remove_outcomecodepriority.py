...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'OutcomeCodePriority'
        db.delete_table(u'legalaid_outcomecodepriority')

    def backwards(self, orm):
        # Adding model 'OutcomeCodePriority'
        db.create_table(u'legalaid_outcomecodepriority', (
        ...
        db.send_create_signal(u'legalaid', ['OutcomeCodePriority'])
