...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Timer.stopped_at'
        db.delete_column(u'timer_timer', 'stopped_at')

        # Adding field 'Timer.stopped'
        db.add_column(u'timer_timer', 'stopped',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Timer.linked_case'
        db.add_column(u'timer_timer', 'linked_case',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legalaid.Case'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Timer.stopped_at'
        db.add_column(u'timer_timer', 'stopped_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Timer.stopped'
        db.delete_column(u'timer_timer', 'stopped')

        # Deleting field 'Timer.linked_case'
        db.delete_column(u'timer_timer', 'linked_case_id')
