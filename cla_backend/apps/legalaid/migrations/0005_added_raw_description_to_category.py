...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.raw_description'
        db.add_column(u'legalaid_category', 'raw_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.raw_description'
        db.delete_column(u'legalaid_category', 'raw_description')
