...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Case.adaptation_details'
        db.add_column(u'legalaid_case', 'adaptation_details',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legalaid.AdaptationDetails'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Case.adaptation_details'
        db.delete_column(u'legalaid_case', 'adaptation_details_id')
