...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MatterType'
        db.create_table(u'legalaid_mattertype', (
        ...
        db.send_create_signal(u'legalaid', ['MatterType'])

        # Adding field 'Case.matter_type1'
        db.add_column(u'legalaid_case', 'matter_type1',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['legalaid.MatterType']),
                      keep_default=False)

        # Adding field 'Case.matter_type2'
        db.add_column(u'legalaid_case', 'matter_type2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['legalaid.MatterType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MatterType'
        db.delete_table(u'legalaid_mattertype')

        # Deleting field 'Case.matter_type1'
        db.delete_column(u'legalaid_case', 'matter_type1_id')

        # Deleting field 'Case.matter_type2'
        db.delete_column(u'legalaid_case', 'matter_type2_id')
