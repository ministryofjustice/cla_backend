...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaseArchived.search_field'
        db.add_column(u'historic_casearchived', 'search_field',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CaseArchived.search_field'
        db.delete_column(u'historic_casearchived', 'search_field')
