...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CaseOutcome'
        db.create_table(u'legalaid_caseoutcome', (
            ...
            ('outcome_code', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legalaid.OutcomeCode'])),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('notes', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'legalaid', ['CaseOutcome'])


    def backwards(self, orm):
        # Deleting model 'CaseOutcome'
        db.delete_table(u'legalaid_caseoutcome')
