...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EligibilityCheck.calculations'
        db.add_column(u'legalaid_eligibilitycheck', 'calculations',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EligibilityCheck.calculations'
        db.delete_column(u'legalaid_eligibilitycheck', 'calculations')
