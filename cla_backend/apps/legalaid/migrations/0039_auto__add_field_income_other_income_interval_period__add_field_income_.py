...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Deductions.income_tax_and_ni_interval_period'
        db.add_column(u'legalaid_deductions', 'income_tax_and_ni_interval_period',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deductions.income_tax_and_ni_per_interval_value'
        db.add_column(u'legalaid_deductions', 'income_tax_and_ni_per_interval_value',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Deductions.mortgage_or_rent_interval_period'
        db.add_column(u'legalaid_deductions', 'mortgage_or_rent_interval_period',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deductions.mortgage_or_rent_per_interval_value'
        db.add_column(u'legalaid_deductions', 'mortgage_or_rent_per_interval_value',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Deductions.mortgage_or_rent'
        db.alter_column(u'legalaid_deductions', 'mortgage_or_rent', self.gf('cla_common.money_interval.fields.MoneyIntervalField')())

        # Changing field 'Deductions.income_tax_and_ni'
        db.alter_column(u'legalaid_deductions', 'income_tax_and_ni', self.gf('cla_common.money_interval.fields.MoneyIntervalField')())
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Deductions.income_tax_and_ni_interval_period'
        db.delete_column(u'legalaid_deductions', 'income_tax_and_ni_interval_period')

        # Deleting field 'Deductions.income_tax_and_ni_per_interval_value'
        db.delete_column(u'legalaid_deductions', 'income_tax_and_ni_per_interval_value')
        ...
        # Deleting field 'Deductions.mortgage_or_rent_interval_period'
        db.delete_column(u'legalaid_deductions', 'mortgage_or_rent_interval_period')

        # Deleting field 'Deductions.mortgage_or_rent_per_interval_value'
        db.delete_column(u'legalaid_deductions', 'mortgage_or_rent_per_interval_value')


        # Changing field 'Deductions.mortgage_or_rent'
        db.alter_column(u'legalaid_deductions', 'mortgage_or_rent', self.gf('legalaid.fields.MoneyField')(max_value=9999999999, min_value=0))

        # Changing field 'Deductions.income_tax_and_ni'
        db.alter_column(u'legalaid_deductions', 'income_tax_and_ni', self.gf('legalaid.fields.MoneyField')(max_value=9999999999, min_value=0))
    ...
    models = {
        ...
        u'legalaid.deductions': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'income_tax_and_ni': ('cla_common.money_interval.fields.MoneyIntervalField', [], {}),
            'income_tax_and_ni_interval_period': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'income_tax_and_ni_per_interval_value': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'mortgage_or_rent': ('cla_common.money_interval.fields.MoneyIntervalField', [], {}),
            'mortgage_or_rent_interval_period': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'mortgage_or_rent_per_interval_value': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'})
        },
