...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.search_field'
        db.add_column(u'legalaid_case', 'search_field',
                      self.gf('django.db.models.fields.TextField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonalDetails.search_field'
        db.add_column(u'legalaid_personaldetails', 'search_field',
                      self.gf('django.db.models.fields.TextField')(db_index=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Case.search_field'
        db.delete_column(u'legalaid_case', 'search_field')

        # Deleting field 'PersonalDetails.search_field'
        db.delete_column(u'legalaid_personaldetails', 'search_field')
    ...
    models = {
        ...
        u'cla_provider.provider': {
            ...
            'opening_hours': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        u'legalaid.case': {
            ...
            'search_field': ('django.db.models.fields.TextField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
