...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Income.other_income_interval_period'
        db.add_column(u'legalaid_income', 'other_income_interval_period',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Income.other_income_per_interval_value'
        db.add_column(u'legalaid_income', 'other_income_per_interval_value',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Income.other_income'
        db.alter_column(u'legalaid_income', 'other_income', self.gf('cla_common.money_interval.fields.MoneyIntervalField')())
        # Deleting field 'Deductions.mortgage_or_rent'
        db.delete_column(u'legalaid_deductions', 'mortgage_or_rent')

        # Deleting field 'Deductions.income_tax_and_ni'
        db.delete_column(u'legalaid_deductions', 'income_tax_and_ni')

        # Adding field 'Deductions.income_tax_interval_period'
        db.add_column(u'legalaid_deductions', 'income_tax_interval_period',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deductions.income_tax_per_interval_value'
        db.add_column(u'legalaid_deductions', 'income_tax_per_interval_value',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deductions.income_tax'
        db.add_column(u'legalaid_deductions', 'income_tax',
                      self.gf('cla_common.money_interval.fields.MoneyIntervalField')(default=0),
                      keep_default=False)

        # Adding field 'Deductions.national_insurance_interval_period'
        db.add_column(u'legalaid_deductions', 'national_insurance_interval_period',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deductions.national_insurance_per_interval_value'
        db.add_column(u'legalaid_deductions', 'national_insurance_per_interval_value',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deductions.national_insurance'
        db.add_column(u'legalaid_deductions', 'national_insurance',
                      self.gf('cla_common.money_interval.fields.MoneyIntervalField')(default=0),
                      keep_default=False)

        # Adding field 'Deductions.maintenance_interval_period'
        db.add_column(u'legalaid_deductions', 'maintenance_interval_period',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deductions.maintenance_per_interval_value'
        db.add_column(u'legalaid_deductions', 'maintenance_per_interval_value',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deductions.childcare_interval_period'
        db.add_column(u'legalaid_deductions', 'childcare_interval_period',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deductions.childcare_per_interval_value'
        db.add_column(u'legalaid_deductions', 'childcare_per_interval_value',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deductions.mortgage_interval_period'
        db.add_column(u'legalaid_deductions', 'mortgage_interval_period',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deductions.mortgage_per_interval_value'
        db.add_column(u'legalaid_deductions', 'mortgage_per_interval_value',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deductions.mortgage'
        db.add_column(u'legalaid_deductions', 'mortgage',
                      self.gf('cla_common.money_interval.fields.MoneyIntervalField')(default=0),
                      keep_default=False)

        # Adding field 'Deductions.rent_interval_period'
        db.add_column(u'legalaid_deductions', 'rent_interval_period',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deductions.rent_per_interval_value'
        db.add_column(u'legalaid_deductions', 'rent_per_interval_value',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deductions.rent'
        db.add_column(u'legalaid_deductions', 'rent',
                      self.gf('cla_common.money_interval.fields.MoneyIntervalField')(default=0),
                      keep_default=False)


        # Changing field 'Deductions.childcare'
        db.alter_column(u'legalaid_deductions', 'childcare', self.gf('cla_common.money_interval.fields.MoneyIntervalField')())

        # Changing field 'Deductions.maintenance'
        db.alter_column(u'legalaid_deductions', 'maintenance', self.gf('cla_common.money_interval.fields.MoneyIntervalField')())

    def backwards(self, orm):
        # Deleting field 'Income.other_income_interval_period'
        db.delete_column(u'legalaid_income', 'other_income_interval_period')

        # Deleting field 'Income.other_income_per_interval_value'
        db.delete_column(u'legalaid_income', 'other_income_per_interval_value')


        # Changing field 'Income.other_income'
        db.alter_column(u'legalaid_income', 'other_income', self.gf('legalaid.fields.MoneyField')(max_value=9999999999, min_value=0))
        # Adding field 'Deductions.mortgage_or_rent'
        db.add_column(u'legalaid_deductions', 'mortgage_or_rent',
                      self.gf('legalaid.fields.MoneyField')(default=0, max_value=9999999999, min_value=0),
                      keep_default=False)

        # Adding field 'Deductions.income_tax_and_ni'
        db.add_column(u'legalaid_deductions', 'income_tax_and_ni',
                      self.gf('legalaid.fields.MoneyField')(default=0, max_value=9999999999, min_value=0),
                      keep_default=False)

        # Deleting field 'Deductions.income_tax_interval_period'
        db.delete_column(u'legalaid_deductions', 'income_tax_interval_period')

        # Deleting field 'Deductions.income_tax_per_interval_value'
        db.delete_column(u'legalaid_deductions', 'income_tax_per_interval_value')

        # Deleting field 'Deductions.income_tax'
        db.delete_column(u'legalaid_deductions', 'income_tax')

        # Deleting field 'Deductions.national_insurance_interval_period'
        db.delete_column(u'legalaid_deductions', 'national_insurance_interval_period')

        # Deleting field 'Deductions.national_insurance_per_interval_value'
        db.delete_column(u'legalaid_deductions', 'national_insurance_per_interval_value')

        # Deleting field 'Deductions.national_insurance'
        db.delete_column(u'legalaid_deductions', 'national_insurance')

        # Deleting field 'Deductions.maintenance_interval_period'
        db.delete_column(u'legalaid_deductions', 'maintenance_interval_period')

        # Deleting field 'Deductions.maintenance_per_interval_value'
        db.delete_column(u'legalaid_deductions', 'maintenance_per_interval_value')

        # Deleting field 'Deductions.childcare_interval_period'
        db.delete_column(u'legalaid_deductions', 'childcare_interval_period')

        # Deleting field 'Deductions.childcare_per_interval_value'
        db.delete_column(u'legalaid_deductions', 'childcare_per_interval_value')

        # Deleting field 'Deductions.mortgage_interval_period'
        db.delete_column(u'legalaid_deductions', 'mortgage_interval_period')

        # Deleting field 'Deductions.mortgage_per_interval_value'
        db.delete_column(u'legalaid_deductions', 'mortgage_per_interval_value')

        # Deleting field 'Deductions.mortgage'
        db.delete_column(u'legalaid_deductions', 'mortgage')

        # Deleting field 'Deductions.rent_interval_period'
        db.delete_column(u'legalaid_deductions', 'rent_interval_period')

        # Deleting field 'Deductions.rent_per_interval_value'
        db.delete_column(u'legalaid_deductions', 'rent_per_interval_value')

        # Deleting field 'Deductions.rent'
        db.delete_column(u'legalaid_deductions', 'rent')


        # Changing field 'Deductions.childcare'
        db.alter_column(u'legalaid_deductions', 'childcare', self.gf('legalaid.fields.MoneyField')(max_value=9999999999, min_value=0))

        # Changing field 'Deductions.maintenance'
        db.alter_column(u'legalaid_deductions', 'maintenance', self.gf('legalaid.fields.MoneyField')(max_value=9999999999, min_value=0))
