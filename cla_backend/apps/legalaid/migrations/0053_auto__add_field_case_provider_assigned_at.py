...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.provider_assigned_at'
        db.add_column(u'legalaid_case', 'provider_assigned_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.provider_assigned_at'
        db.delete_column(u'legalaid_case', 'provider_assigned_at')
