...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deductions.childcare'
        db.add_column(u'legalaid_deductions', 'childcare',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deductions.childcare'
        db.delete_column(u'legalaid_deductions', 'childcare')
