...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'legalaid_case', 'provider',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cla_provider.Provider'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.provider'
        db.delete_column(u'legalaid_case', 'provider_id')
