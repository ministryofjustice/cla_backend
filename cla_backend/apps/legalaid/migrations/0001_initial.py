...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'legalaid_eligibilitycheck', (
            ...
            ('your_finances', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='your_savings', null=True, to=orm['legalaid.Finance'])),
            ('partner_finances', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='partner_savings', null=True, to=orm['legalaid.Finance'])),
            ('notes', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('state', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('dependants_young', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('dependants_old', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        ...
        db.create_table(u'legalaid_case', (
            ...
            ('eligibility_check', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['legalaid.EligibilityCheck'], unique=True)),
