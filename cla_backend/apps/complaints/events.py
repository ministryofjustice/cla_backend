        ...
        [
            ...
            (
                "OWNER_SET",
                {
                    ...
                    "level": LOG_LEVELS.HIGH,
                    "selectable_by": [],
                    "description": "Complaint owner set",
                    "stops_timer": False,
                },
            ),
            (
            ...
            (
                "HOLDING_LETTER_SENT",
                {
                    ...
                    "level": LOG_LEVELS.HIGH,
                    "selectable_by": [LOG_ROLES.OPERATOR],
                    "description": "Complaint holding letter sent",
                    "stops_timer": False,
                },
            ),
            (
                "TRANSFERRED_TO_SPECIALIST",
                {
                    ...
                    "level": LOG_LEVELS.HIGH,
                    "selectable_by": [LOG_ROLES.OPERATOR],
                    "description": "Complaint transferred to specialist",
                    "stops_timer": False,
                },
            ),
            (
                "FULL_RESPONSE_SENT",
                {
                    ...
                    "level": LOG_LEVELS.HIGH,
                    "selectable_by": [LOG_ROLES.OPERATOR],
                    "description": "Complaint full response sent",
                    "stops_timer": False,
                },
            ),
            (
