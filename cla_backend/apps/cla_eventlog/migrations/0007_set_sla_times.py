...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        cbxs = orm['cla_eventlog.Log']\
            .objects.filter(code__startswith='CB')\
            .exclude(context=None)
        for cb in cbxs:
            requires_action_at = cb.context.get('requires_action_at')
            if requires_action_at:
                requires_action_at = parse(requires_action_at)
