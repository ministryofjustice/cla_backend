...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ThirdPartyDetails.reason'
        db.alter_column(u'legalaid_thirdpartydetails', 'reason', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'ThirdPartyDetails.reason'
        db.alter_column(u'legalaid_thirdpartydetails', 'reason', self.gf('django.db.models.fields.CharField')(default='', max_length=30))
