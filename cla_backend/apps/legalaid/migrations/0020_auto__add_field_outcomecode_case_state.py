...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OutcomeCode.case_state'
        db.add_column(u'legalaid_outcomecode', 'case_state',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OutcomeCode.case_state'
        db.delete_column(u'legalaid_outcomecode', 'case_state')
