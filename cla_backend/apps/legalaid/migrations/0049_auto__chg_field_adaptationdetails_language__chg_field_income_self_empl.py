...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdaptationDetails.language'
        db.alter_column(u'legalaid_adaptationdetails', 'language', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AdaptationDetails.language'
        db.alter_column(u'legalaid_adaptationdetails', 'language', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Income.self_employed'
        db.alter_column(u'legalaid_income', 'self_employed', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Income.earnings'
        db.alter_column(u'legalaid_income', 'earnings', self.gf('cla_common.money_interval.fields.MoneyIntervalField')(default=''))
        ...
        # Changing field 'Case.eligibility_check'
        db.alter_column(u'legalaid_case', 'eligibility_check_id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['legalaid.EligibilityCheck'], unique=True))
