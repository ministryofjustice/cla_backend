...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProviderPreAllocation'
        db.create_table(u'cla_provider_providerpreallocation', (
        ...
        db.send_create_signal(u'cla_provider', ['ProviderPreAllocation'])


    def backwards(self, orm):
        # Deleting model 'ProviderPreAllocation'
        db.delete_table(u'cla_provider_providerpreallocation')
    ...
    models = {
        ...
        u'cla_provider.providerpreallocation': {
            'Meta': {'object_name': 'ProviderPreAllocation'},
        ...
        u'cla_provider.staff': {
            ...
            'chs_organisation': ('django.db.models.fields.CharField', [], {'default': "'e89827be-2c91-4aa6-9053-1dd6b44ec02b'", 'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'chs_password': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'chs_user': ('django.db.models.fields.CharField', [], {'default': "'54ef4dfa-445f-45f1-a1b3-96401ff1d887'", 'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'legalaid.case': {
            ...
            'provider_assigned_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
