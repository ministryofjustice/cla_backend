...
CASE_STATE_MAPPING_REVERSE = {
    v:k for k,v in CASE_STATE_MAPPING.items()
}
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # migrating
        for case_log_type in orm.CaseLogType.objects.all():
            if case_log_type.case_state in CASE_STATE_MAPPING.values():
                continue
    ...
    models = {
        ...
        u'legalaid.eligibilitycheck': {
            ...
            'state': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': "'unknown'"}),
