...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Staff', fields ['chs_organisation', 'chs_user', 'chs_password']
        db.delete_unique(u'cla_provider_staff', ['chs_organisation', 'chs_user', 'chs_password'])

        # Adding unique constraint on 'Staff', fields ['chs_organisation', 'chs_user']
        db.create_unique(u'cla_provider_staff', ['chs_organisation', 'chs_user'])


    def backwards(self, orm):
        # Removing unique constraint on 'Staff', fields ['chs_organisation', 'chs_user']
        db.delete_unique(u'cla_provider_staff', ['chs_organisation', 'chs_user'])

        # Adding unique constraint on 'Staff', fields ['chs_organisation', 'chs_user', 'chs_password']
        db.create_unique(u'cla_provider_staff', ['chs_organisation', 'chs_user', 'chs_password'])
    ...
    models = {
        ...
        u'cla_provider.staff': {
            ...
            'chs_organisation': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'chs_password': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'chs_user': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
