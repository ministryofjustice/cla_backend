...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Provider.telephone_frontdoor'
        db.add_column(u'cla_provider_provider', 'telephone_frontdoor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Provider.telephone_backdoor'
        db.add_column(u'cla_provider_provider', 'telephone_backdoor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Provider.telephone_frontdoor'
        db.delete_column(u'cla_provider_provider', 'telephone_frontdoor')

        # Deleting field 'Provider.telephone_backdoor'
        db.delete_column(u'cla_provider_provider', 'telephone_backdoor')
