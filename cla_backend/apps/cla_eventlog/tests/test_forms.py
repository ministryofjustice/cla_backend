...
class BaseCaseLogFormTestCaseMixin(object):
    ...
    def test_invalid_form(self):
        ...
        self.assertCountEqual(form.errors["notes"], ["Ensure this value has at most 5000 characters (it has 5001)."])
...
class EventSpecificLogFormTestCaseMixin(BaseCaseLogFormTestCaseMixin):
    ...
    def test_invalid_event_code(self):
        ...
        self.assertCountEqual(form.errors, {"event_code": ["Invalid choice"]})
