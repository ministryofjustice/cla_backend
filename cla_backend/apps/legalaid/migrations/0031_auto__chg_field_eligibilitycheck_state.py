...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EligibilityCheck.state'
        db.alter_column(u'legalaid_eligibilitycheck', 'state', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'EligibilityCheck.state'
        db.alter_column(u'legalaid_eligibilitycheck', 'state', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
