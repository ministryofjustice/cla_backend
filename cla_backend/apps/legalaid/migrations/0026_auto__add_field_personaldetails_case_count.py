...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonalDetails.case_count'
        db.add_column(u'legalaid_personaldetails', 'case_count',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonalDetails.case_count'
        db.delete_column(u'legalaid_personaldetails', 'case_count')
