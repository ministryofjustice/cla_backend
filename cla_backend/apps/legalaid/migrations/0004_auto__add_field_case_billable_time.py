...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.billable_time'
        db.add_column(u'legalaid_case', 'billable_time',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.billable_time'
        db.delete_column(u'legalaid_case', 'billable_time')
