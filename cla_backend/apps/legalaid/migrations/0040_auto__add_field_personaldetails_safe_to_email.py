...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonalDetails.safe_to_email'
        db.add_column(u'legalaid_personaldetails', 'safe_to_email',
                      self.gf('django.db.models.fields.CharField')(default='SAFE', max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonalDetails.safe_to_email'
        db.delete_column(u'legalaid_personaldetails', 'safe_to_email')
