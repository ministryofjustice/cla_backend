...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        for obj in orm['legalaid.personaldetails'].objects.all():
            if not obj.reference:
                obj.reference = uuid.uuid4()
                obj.save()

        # Changing field 'PersonalDetails.reference'
        db.alter_column(u'legalaid_personaldetails', 'reference', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32))

    def backwards(self, orm):

        # Changing field 'PersonalDetails.reference'
        db.alter_column(u'legalaid_personaldetails', 'reference', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, null=True))
