...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Case.thirdparty_details'
        db.add_column(u'legalaid_case', 'thirdparty_details',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legalaid.ThirdPartyDetails'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Case.thirdparty_details'
        db.delete_column(u'legalaid_case', 'thirdparty_details_id')
