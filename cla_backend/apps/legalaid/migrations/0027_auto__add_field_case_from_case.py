...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.from_case'
        db.add_column(u'legalaid_case', 'from_case',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['legalaid.Case'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.from_case'
        db.delete_column(u'legalaid_case', 'from_case_id')
    ...
    models = {
        ...
        u'legalaid.case': {
            ...
            'from_case': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['legalaid.Case']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
