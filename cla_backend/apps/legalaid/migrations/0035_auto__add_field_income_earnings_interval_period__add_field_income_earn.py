...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Income.earnings_interval_period'
        db.add_column(u'legalaid_income', 'earnings_interval_period',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Income.earnings_per_interval_value'
        db.add_column(u'legalaid_income', 'earnings_per_interval_value',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Income.earnings'
        db.alter_column(u'legalaid_income', 'earnings', self.gf('legalaid.fields.MoneyFieldX')())
    ...
    def backwards(self, orm):
        # Deleting field 'Income.earnings_interval_period'
        db.delete_column(u'legalaid_income', 'earnings_interval_period')

        # Deleting field 'Income.earnings_per_interval_value'
        db.delete_column(u'legalaid_income', 'earnings_per_interval_value')


        # Changing field 'Income.earnings'
        db.alter_column(u'legalaid_income', 'earnings', self.gf('legalaid.fields.MoneyField')(max_value=99999999, min_value=0))
    ...
    models = {
        ...
        u'legalaid.deductions': {
            ...
            'childcare': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '9999999999', 'min_value': '0'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'criminal_legalaid_contributions': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '9999999999', 'min_value': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'income_tax_and_ni': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '9999999999', 'min_value': '0'}),
            'maintenance': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '9999999999', 'min_value': '0'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'mortgage_or_rent': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '9999999999', 'min_value': '0'})
        },
        ...
        u'legalaid.income': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'earnings': ('legalaid.fields.MoneyFieldX', [], {'default': '0'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'other_income': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '9999999999', 'min_value': '0'}),
