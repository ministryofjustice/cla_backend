...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.provider_notes'
        db.add_column(u'legalaid_case', 'provider_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.provider_notes'
        db.delete_column(u'legalaid_case', 'provider_notes')
