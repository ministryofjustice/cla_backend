...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Staff.is_staff_superuser'
        db.delete_column(u'cla_provider_staff', 'is_staff_superuser')

        # Adding field 'Staff.is_manager'
        db.add_column(u'cla_provider_staff', 'is_manager',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Staff.is_staff_superuser'
        db.add_column(u'cla_provider_staff', 'is_staff_superuser',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Staff.is_manager'
        db.delete_column(u'cla_provider_staff', 'is_manager')
