    ...
    operator_first_view_after_cb1 as (
      ...
      from cla_eventlog_log o
        ...
        LEFT JOIN cla_eventlog_log log_call_started on
                                  ...
                                  and WHERE log_call_started.code IN ('TERM', 'ABND', 'PCB', 'COPE', 'DUPL', 'INSUF', 'IRCB', 'NCOE', 'DESP', 'DECL', 'IRKB', 'MRCC', 'NRES', 'SAME', 'COSPF', 'SPFM', 'SPFN', 'CBSP', 'MANALC', 'MANREF', 'RDSP', 'REFSP', 'SPOR', 'WROF', 'REFDPA', 'RELBD', 'RSTR', 'NOLA')
