...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PersonalDetails.mobile_phone'
        db.alter_column(u'legalaid_personaldetails', 'mobile_phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'PersonalDetails.full_name'
        db.alter_column(u'legalaid_personaldetails', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'PersonalDetails.title'
        db.alter_column(u'legalaid_personaldetails', 'title', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'PersonalDetails.street'
        db.alter_column(u'legalaid_personaldetails', 'street', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'PersonalDetails.postcode'
        db.alter_column(u'legalaid_personaldetails', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

    def backwards(self, orm):

        # Changing field 'PersonalDetails.mobile_phone'
        db.alter_column(u'legalaid_personaldetails', 'mobile_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'PersonalDetails.full_name'
        db.alter_column(u'legalaid_personaldetails', 'full_name', self.gf('django.db.models.fields.CharField')(default='', max_length=400))

        # Changing field 'PersonalDetails.title'
        db.alter_column(u'legalaid_personaldetails', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'PersonalDetails.street'
        db.alter_column(u'legalaid_personaldetails', 'street', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'PersonalDetails.postcode'
        db.alter_column(u'legalaid_personaldetails', 'postcode', self.gf('django.db.models.fields.CharField')(default='', max_length=12))
