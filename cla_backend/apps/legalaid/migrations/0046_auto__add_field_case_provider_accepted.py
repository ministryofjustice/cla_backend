...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.provider_accepted'
        db.add_column(u'legalaid_case', 'provider_accepted',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.provider_accepted'
        db.delete_column(u'legalaid_case', 'provider_accepted')
