...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'legalaid_income', 'other_income', self.gf('legalaid.fields.MoneyField')(max_value=99999999, min_value=0))

        # Changing field 'Savings.credit_balance'
        db.alter_column(u'legalaid_savings', 'credit_balance', self.gf('legalaid.fields.MoneyField')(max_value=99999999, min_value=0))

        # Changing field 'Savings.asset_balance'
        db.alter_column(u'legalaid_savings', 'asset_balance', self.gf('legalaid.fields.MoneyField')(max_value=99999999, min_value=0))

        # Changing field 'Savings.investment_balance'
        db.alter_column(u'legalaid_savings', 'investment_balance', self.gf('legalaid.fields.MoneyField')(max_value=99999999, min_value=0))

        # Changing field 'Savings.bank_balance'
        db.alter_column(u'legalaid_savings', 'bank_balance', self.gf('legalaid.fields.MoneyField')(max_value=99999999, min_value=0))

        # Changing field 'Deductions.mortgage_or_rent'
        db.alter_column(u'legalaid_deductions', 'mortgage_or_rent', self.gf('legalaid.fields.MoneyField')(max_value=99999999, min_value=0))

        # Changing field 'Deductions.income_tax_and_ni'
        db.alter_column(u'legalaid_deductions', 'income_tax_and_ni', self.gf('legalaid.fields.MoneyField')(max_value=99999999, min_value=0))

        # Changing field 'Deductions.childcare'
        db.alter_column(u'legalaid_deductions', 'childcare', self.gf('legalaid.fields.MoneyField')(max_value=99999999, min_value=0))

        # Changing field 'Deductions.maintenance'
        db.alter_column(u'legalaid_deductions', 'maintenance', self.gf('legalaid.fields.MoneyField')(max_value=99999999, min_value=0))

        # Changing field 'Deductions.criminal_legalaid_contributions'
        db.alter_column(u'legalaid_deductions', 'criminal_legalaid_contributions', self.gf('legalaid.fields.MoneyField')(max_value=99999999, min_value=0))

        # Changing field 'Property.value'
        db.alter_column(u'legalaid_property', 'value', self.gf('legalaid.fields.MoneyField')(max_value=99999999, min_value=0))

        # Changing field 'Property.mortgage_left'
        db.alter_column(u'legalaid_property', 'mortgage_left', self.gf('legalaid.fields.MoneyField')(max_value=99999999, min_value=0))

    def backwards(self, orm):

        # Changing field 'Income.other_income'
        db.alter_column(u'legalaid_income', 'other_income', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Savings.credit_balance'
        db.alter_column(u'legalaid_savings', 'credit_balance', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Savings.asset_balance'
        db.alter_column(u'legalaid_savings', 'asset_balance', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Savings.investment_balance'
        db.alter_column(u'legalaid_savings', 'investment_balance', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Savings.bank_balance'
        db.alter_column(u'legalaid_savings', 'bank_balance', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Deductions.mortgage_or_rent'
        db.alter_column(u'legalaid_deductions', 'mortgage_or_rent', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Deductions.income_tax_and_ni'
        db.alter_column(u'legalaid_deductions', 'income_tax_and_ni', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Deductions.childcare'
        db.alter_column(u'legalaid_deductions', 'childcare', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Deductions.maintenance'
        db.alter_column(u'legalaid_deductions', 'maintenance', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Deductions.criminal_legalaid_contributions'
        db.alter_column(u'legalaid_deductions', 'criminal_legalaid_contributions', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Property.value'
        db.alter_column(u'legalaid_property', 'value', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Property.mortgage_left'
        db.alter_column(u'legalaid_property', 'mortgage_left', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        u'legalaid.caselogtype': {
            ...
            'case_state': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        u'legalaid.deductions': {
            ...
            'childcare': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '99999999', 'min_value': '0'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'criminal_legalaid_contributions': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '99999999', 'min_value': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'income_tax_and_ni': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '99999999', 'min_value': '0'}),
            'maintenance': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '99999999', 'min_value': '0'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'mortgage_or_rent': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '99999999', 'min_value': '0'})
        },
        ...
        u'legalaid.income': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'earnings': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '99999999', 'min_value': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'other_income': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '99999999', 'min_value': '0'}),
        ...
        u'legalaid.property': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'mortgage_left': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '99999999', 'min_value': '0'}),
            'share': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'value': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '99999999', 'min_value': '0'})
        },
        u'legalaid.savings': {
            'Meta': {'object_name': 'Savings'},
            'asset_balance': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '99999999', 'min_value': '0'}),
            'bank_balance': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '99999999', 'min_value': '0'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'credit_balance': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '99999999', 'min_value': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'investment_balance': ('legalaid.fields.MoneyField', [], {'default': '0', 'max_value': '99999999', 'min_value': '0'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'})
        }
    }
