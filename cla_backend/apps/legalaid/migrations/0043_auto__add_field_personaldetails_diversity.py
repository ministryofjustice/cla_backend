...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonalDetails.diversity'
        db.add_column(u'legalaid_personaldetails', 'diversity',
                      self.gf('django.db.models.fields.BinaryField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonalDetails.diversity'
        db.delete_column(u'legalaid_personaldetails', 'diversity')
