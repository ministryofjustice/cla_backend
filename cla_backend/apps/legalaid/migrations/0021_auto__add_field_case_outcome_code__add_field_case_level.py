...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.outcome_code'
        db.add_column(u'legalaid_case', 'outcome_code',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Case.level'
        db.add_column(u'legalaid_case', 'level',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.outcome_code'
        db.delete_column(u'legalaid_case', 'outcome_code')

        # Deleting field 'Case.level'
        db.delete_column(u'legalaid_case', 'level')
