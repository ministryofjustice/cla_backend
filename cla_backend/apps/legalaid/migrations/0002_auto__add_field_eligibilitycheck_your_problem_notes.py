...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EligibilityCheck.your_problem_notes'
        db.add_column(u'legalaid_eligibilitycheck', 'your_problem_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EligibilityCheck.your_problem_notes'
        db.delete_column(u'legalaid_eligibilitycheck', 'your_problem_notes')
