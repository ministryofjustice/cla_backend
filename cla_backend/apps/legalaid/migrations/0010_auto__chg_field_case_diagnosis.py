...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Case.diagnosis'
        db.alter_column(u'legalaid_case', 'diagnosis_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['diagnosis.DiagnosisTraversal'], unique=True, null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Case.diagnosis'
        db.alter_column(u'legalaid_case', 'diagnosis_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['diagnosis.DiagnosisTraversal'], unique=True, null=True))
