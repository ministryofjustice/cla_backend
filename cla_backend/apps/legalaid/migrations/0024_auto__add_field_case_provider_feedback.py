...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("cla_provider", "0003_auto__add_feedback"),
    )
    ...
    models = {
        ...
        u'legalaid.case': {
            ...
            'provider_feedback': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['cla_provider.Feedback']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
