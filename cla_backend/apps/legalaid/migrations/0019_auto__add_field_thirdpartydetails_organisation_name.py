...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ThirdPartyDetails.organisation_name'
        db.add_column(u'legalaid_thirdpartydetails', 'organisation_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ThirdPartyDetails.organisation_name'
        db.delete_column(u'legalaid_thirdpartydetails', 'organisation_name')
