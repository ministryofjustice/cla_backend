...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Staff.chs_organisation'
        db.add_column(u'cla_provider_staff', 'chs_organisation',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.chs_user'
        db.add_column(u'cla_provider_staff', 'chs_user',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.chs_password'
        db.add_column(u'cla_provider_staff', 'chs_password',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Staff.chs_organisation'
        db.delete_column(u'cla_provider_staff', 'chs_organisation')

        # Deleting field 'Staff.chs_user'
        db.delete_column(u'cla_provider_staff', 'chs_user')

        # Deleting field 'Staff.chs_password'
        db.delete_column(u'cla_provider_staff', 'chs_password')
