...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'MatterType', fields ['code', 'level']
        db.create_unique(u'legalaid_mattertype', ['code', 'level'])


    def backwards(self, orm):
        # Removing unique constraint on 'MatterType', fields ['code', 'level']
        db.delete_unique(u'legalaid_mattertype', ['code', 'level'])
