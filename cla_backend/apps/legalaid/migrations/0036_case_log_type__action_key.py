...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaseLogType.action_key'
        db.add_column(u'legalaid_caselogtype', 'action_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CaseLogType.action_key'
        db.delete_column(u'legalaid_caselogtype', 'action_key')
